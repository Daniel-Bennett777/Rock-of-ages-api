...
class RockView(ViewSet):
    ...
    def destroy(self, request, pk=None):
        ...
        try:
            ...
            # Check if the authenticated user is the owner of the rock
    ...
    def list(self, request):
        """Handle GET requests for rocks belonging to the authenticated user
        ...
        try:
            ...
            # Filter rocks belonging to the authenticated user
